...
######## - Changed 
    ...
    if version >= Version("2017.1"):
        major = version.major - 2014
        minor = version.minor
        micro = version.micro
        version = Version(f"{major}.{minor}.{micro}")
    return version
...
def get_file_info(filename, info):
    ...
    return props.get('StringFileInfo').get('ProductVersion')
...
######## - Changed 
    EXECUTABLE_TEMPLATES = {
        "darwin": ["/Applications/Adobe/Substance Painter.app"],
